            ...
            if (jsonValue !== undefined) {
                if (Array.isArray(this.value)) {
                    for (const value of this.value) {
                        match = this.evaluateRegexOrString(this.operator, value, jsonValue, ignoreCase);
                    ...
                    match = this.evaluateRegexOrString(this.operator, this.value, jsonValue, ignoreCase);
                }
            }
            return match;
