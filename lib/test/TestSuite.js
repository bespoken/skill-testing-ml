...
module.exports = class TestSuite {
    ...
    get excludedTags() {
        return Configuration.instance().value("excludedTags", this.configuration);
    }

    get includedTags() {
        return Configuration.instance().value("includedTags", this.configuration);
    }
    ...
    processIncludedAndExcludedTags() {
        const includedTagsRaw =  this.includedTags;
        const excludedTagsRaw =  this.excludedTags;
