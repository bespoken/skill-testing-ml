...
class TestSuite {
    ...
    get maxAsyncE2EResponseWaitTime() {
        return Configuration.instance().value("maxAsyncE2EResponseWaitTime", this.configuration, 25000);
    }
    ...
    processIncludedAndExcludedTags() {
        ...
        const suiteTags = typeof this.tags === "object" ? this.tags : this.getTagsFromString(this.tags);
