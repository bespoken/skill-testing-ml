...
class TestSuite {
     ...
     * @param {object[]} localizedValues - Array of objects {key, value} where the keys are be the file name without
     * extension and the value will be a key value object with the localization values
     */
    ...
    /**
     * Get the express module configured for Google Assistant Unit tests if it exist
    ...
    /**
     * Get the express port configured for Google Assistant Unit tests if it exist
    ...
    /**
     * Array of objects {key, value} where the keys are be the file name without
     * extension and the value will be a key value object with the localization values
    ...
    /****
     * Raw test elements obtained from parsing the yaml file to a object
