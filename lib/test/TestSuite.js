...
class TestSuite {
    ...
    get interactionModel() {
        ...
        return `./models/${this.locale}.json`;
    }
     ...
     * @return {list} error code list, defaults to [553, 554]
     */
    get retryOn() {
        return Configuration.instance().value("retryOn", this.configuration, [553, 554, 556]);
    }
     ...
     */
    get retryNumber() {
        return Configuration.instance().value("retryNumber", this.configuration, 2);
    }
