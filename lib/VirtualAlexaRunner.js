...
module.exports = class VirtualAlexaRunner extends TestRunner {
    ...
    async runSuite(testSuite) {
        ...
        this.setupAlexaState(virtualAlexa, testSuite);
    ...
    setupAlexaState(virtualAlexa, testSuite) {
    ...
    async interact(virtualAlexa, testSuite, test, interaction) {
        ...
        let response;
        try {
            response = await this.invoke(virtualAlexa, interaction);
        } catch (e) {
    ...
    async invoke(virtualAlexa, interaction) {
        let response;
        if (interaction.utterance === "LaunchRequest") {
            ...
            response = await virtualAlexa.audioPlayer().audioPlayerRequest(interaction.utterance);
