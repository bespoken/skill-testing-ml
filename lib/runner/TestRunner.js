...
module.exports = class TestRunner {
    ...
    getLocalizedValues(testSuite, assertion) {
        if (Array.isArray(assertion.value)) {
    ...
    processResponse(response, testSuite, context) {
        ...
        for (const assertion of interaction.assertions) {
            ...
            const localizedValues = this.getLocalizedValues(testSuite, assertion);

            const passed = assertion.evaluate(response, localizedValues);
            if (passed) {
