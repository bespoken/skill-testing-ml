...
module.exports = class TestRunner {
    ...
    async runSuite(testSuite, context) {
        ...
        for (const test of testSuite.tests) {
            ...
            const testSerialized = test.toString();
            this.emit("message", undefined, testSerialized, context);
            ...
            testSerialized.interactionResults = results.map(result => result.toString());
            this.emit("result", undefined, testSerialized, context);
