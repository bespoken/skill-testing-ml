...
const VirtualDeviceInvoker = require("./VirtualDeviceInvoker");

const invokerList = {
    VirtualAlexaInvoker,
    VirtualDeviceInvoker
};
...
module.exports = class TestRunner {
    ...
    async runSuiteForLocale(testSuite, context, locale) {
        ...
        const invoker = new invokerList[testSuite.invoker](this);
        try {
            invoker.before(testSuiteWithLocale);
        } catch (error) {
        ...
        invoker.after(testSuiteWithLocale);
        return testResults;
    }
