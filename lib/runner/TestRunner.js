...
module.exports = class TestRunner {
    ...
    async runSuite(testSuite, context) {
        ...
        if (locales) {
            const localesList = locales.split(",");
    ...
    async runSuiteForLocale(testSuite, context, locale) {
        ...
        const testSuiteWithLocale = Object.assign(Object.create(testSuite), testSuite)
    ...
    processResponse(response, testSuite, context) {
        ...
        for (const assertion of interaction.assertions) {
            ...
            const passed = assertion.evaluate(response, testSuite);
            if (passed) {
