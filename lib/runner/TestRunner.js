...
module.exports = class TestRunner {
    ...
    async runSuite(testSuite, context) {
        ...
        // if at least one test suite is of type unit, we set the coverage link, otherwise we ensure is removed (in case of previous tests)
        if (testSuite.type === CONSTANTS.TYPE.unit) {
    ...
    async runSuiteForLocale(testSuite, context, locale) {
        ...
        this.replaceLocalizedUtterances(testSuiteWithLocale);
    ...
    replaceLocalizedUtterances(testSuite) {
