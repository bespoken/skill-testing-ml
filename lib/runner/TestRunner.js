...
module.exports = class TestRunner {
    ...
    async runSuiteForLocale(testSuite, context, locale) {
        ...
        if (testSuite.filterObject() && testSuite.filterObject().onTestSuiteStart) {
            await testSuite.filterObject().onTestSuiteStart(testSuite, context, locale);
        }
        ...
        for (const test of testSuiteWithLocale.tests) {
            ...
            if (testSuite.filterObject() && testSuite.filterObject().onTestEnd) {
                await testSuite.filterObject().onTestEnd(test);
            }
        }
