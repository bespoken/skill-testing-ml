...
module.exports = class Configuration {
    static async configure(json, pathName) {
        if (Configuration.singleton) {
            return;
        }
        Configuration.singleton = new Configuration();
        return this.singleton.load(json, pathName);
    }
    ...
    async load(json, pathName) {
        ...
        if (this.configurationJSON.configurationPath) {
            ...
            const relativePath = path.relative(process.cwd(), path.dirname(this.configurationJSON.configurationPath));
            jestConfig.coverageDirectory = `${relativePath}/coverage/`;
        }
