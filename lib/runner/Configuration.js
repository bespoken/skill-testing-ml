...
module.exports = class Configuration {
    ...
    async load(json, pathName, cliOverrides) {
        ...
        if (jestReporters) {
            ...
            this.configurationJSON.jest.reporters = ["default", this.htmlReporterConfiguration()];
        }
    ...
    htmlReporterConfiguration () {
        const pathToModule = path.join(__dirname, "../../node_modules/jest-stare");
    ...
    setUpReporters(jestConfig, reporters) {
        ...
        if (reporters.includes("html")) {
            jestConfig.reporters.push(this.htmlReporterConfiguration());
        }
    }
};