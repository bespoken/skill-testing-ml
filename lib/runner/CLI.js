...
class CLI {
    ...
    async run(argv, configurationOverrides) {
        ...
        // runInBand override default behavior
        const runInBandFromConf = Configuration.instance().value("runInBand", undefined, undefined);
        if (typeof(runInBandFromConf) !== "undefined") {
            runInBand = runInBandFromConf;
        }
