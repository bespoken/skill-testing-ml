...
module.exports = class VirtualDeviceInvoker extends Invoker {
    ...
    before(testSuite) {
        ...
        debug("Virtual Device instance creation: ", { lat, lng, locale, stt, virtualDeviceAsyncMode, virtualDeviceToken, voiceId });
        this._virtualDevice = new VirtualDevice(virtualDeviceToken, locale, voiceId, undefined, virtualDeviceAsyncMode, stt, lat, lng);
