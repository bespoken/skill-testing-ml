...
module.exports = class VirtualDeviceInvoker extends Invoker {
    ...
    beforeTest(test) {
        maxResponseWaitTime = test.testSuite.maxAsyncE2EResponseWaitTime;
        const pauseInteraction = test.hasPause;
        if (pauseInteraction) {
            const pause = pauseInteraction.pauseSeconds;
            maxResponseWaitTime += pause*1000;
            debug("Setting maxResponseWaitTime: ", maxResponseWaitTime);
        }
