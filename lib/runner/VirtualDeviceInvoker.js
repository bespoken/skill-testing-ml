...
class VirtualDeviceResponse extends InvokerResponse {
    ...
    supported (jsonPath) {
        ...
        if (ignorePropertiesRaw
            && ignorePropertiesRaw[platform]
            && ignorePropertiesRaw[platform]["type"] == "e2e") {
        ...
        const includeBasicPaths = ["cardContent", "cardImageURL", "cardTitle", "prompt", "streamURL"].includes(jsonPath);
